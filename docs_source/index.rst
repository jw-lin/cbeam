...
If you have questions, suggestions, or would like to contribute, feel free to contact me at ``jlin@seti.org``.

.. note::

   ``cbeam`` is a work in progress. Currently, the package assumes weak guidance and unidirectional/paraxial propagation. Vectorial propagation, radiative losses, graded refractive indices, and back reflection are not currently supported. There may be bugs.
